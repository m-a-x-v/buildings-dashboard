...
type Action =
  ...
  | { type: 'success'; raw: BuildingsApiResponse | null; derived: ReturnType<typeof normalizeBuildingsData> }
      ...
      .then(async (response) => {
        ...
        if (!cachedSummary) {
          previewTimer = setTimeout(() => {
            ...
            fetchBuildingsRange('bytes=0-2000000', localPreviewController.signal)
